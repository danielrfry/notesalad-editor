...
const THIRD_PARTY_LICENCES_URL =
    process.env.PUBLIC_URL + '/3rdpartylicences.html';

const AboutDialog = ({ open, onClose }) => (
    <CustomDialog title="About Note Salad Editor" open={open} onClose={onClose}>
        <div className="aboutDialog__content">
            <TitledGroup title="ABOUT">
                <p style={{ maxWidth: '100%' }}>
                    Patch editor, MIDI implementation and software synthesizer
                    for the Yamaha OPL, OPM and SD-1 FM synthesizer chips.
                </p>
                <p>
                    <a
